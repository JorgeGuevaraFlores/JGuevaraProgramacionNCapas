			...
			switch (result)
			{
				case SignInStatus.Success:
					...
					if (user != null)
					{
						...
						var key = Encoding.ASCII.GetBytes(ConfigurationManager.AppSettings["JwtSecretKey"]); // Usa una clave segura
						...
						// Puedes retornar el JWT como parte de la respuesta (JSON)
						return Json(new { token = tokenString });
					}

					// Si no hay usuario encontrado, redirige normalmente
